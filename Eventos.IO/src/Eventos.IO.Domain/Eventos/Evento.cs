...
namespace Eventos.IO.Domain.Eventos
{
    public class Evento : Entity<Evento>
    {
        ...
        private void ValidarValor()
        {
            ...
            if (Gratuito)
                RuleFor(c => c.Valor)
                    .ExclusiveBetween(0, 0).WithMessage("O valor não pode ser diferente de 0 para um evento gratuito");
        }
        ...
        private void ValidarData()
        {
            RuleFor(c => c.DataInicio)
                ...
                .WithMessage("A data de início deve ser maior que data do final do evento");
